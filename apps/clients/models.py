...
class ObjectifSportif(models.Model):
    """Objectifs sportifs configurables (Perte de poids, Prise de masse...) —
    modifiable/extensible depuis l'interface, sans toucher au code."""
...
class Client(models.Model):
    ...
    objectif = models.ForeignKey(
        ObjectifSportif, on_delete=models.PROTECT, null=True, blank=True,
        related_name='clients', verbose_name="Objectif sportif"
    )
    ...
    contact_urgence_nom = models.CharField(max_length=200, blank=True, verbose_name="Personne d'urgence")
    contact_urgence_telephone = models.CharField(max_length=20, blank=True, verbose_name="Contact d'urgence")
